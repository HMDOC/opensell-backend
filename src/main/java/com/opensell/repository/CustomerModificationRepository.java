...
public interface CustomerModificationRepository extends CrudRepository<Customer, Integer> {
    ...
    //
    @Modifying
    @Query(value = "update customer_info ci, customer c set ci.primary_address = ?1 where ci.id_customer_info = c.customer_info_id and c.id_customer = ?2", nativeQuery = true)
    public abstract int updateCustomerPrimaryAddress(String address, int customerId);
    ...
    //
    @Modifying
    @Query(value = "UPDATE customer_info ci, customer c SET ci.link1 = ?1 where ci.id_customer_info = c.customer_info_id and c.id_customer = ?2", nativeQuery = true)
    public abstract int updateCustomerSocials1(String link, int customerId);

    //
    @Modifying
    @Query(value = "UPDATE customer_info ci, customer c SET ci.link2 = ?1 where ci.id_customer_info = c.customer_info_id and c.id_customer = ?2", nativeQuery = true)
    public abstract int updateCustomerSocials2(String link, int customerId);

    //
    @Modifying
    @Query(value = "UPDATE customer_info ci, customer c SET ci.link3 = ?1 where ci.id_customer_info = c.customer_info_id and c.id_customer = ?2", nativeQuery = true)
    public abstract int updateCustomerSocials3(String link, int customerId);

    //
    @Modifying
    @Query(value = "UPDATE customer_info ci, customer c SET ci.link4 = ?1 where ci.id_customer_info = c.customer_info_id and c.id_customer = ?2", nativeQuery = true)
    public abstract int updateCustomerSocials4(String link, int customerId);

    //
    @Modifying
    @Query(value = "UPDATE customer_info ci, customer c SET ci.link5 = ?1 where ci.id_customer_info = c.customer_info_id and c.id_customer = ?2", nativeQuery = true)
    public abstract int updateCustomerSocials5(String link, int customerId);
}
